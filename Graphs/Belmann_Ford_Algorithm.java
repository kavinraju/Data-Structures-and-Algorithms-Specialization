...
class Graph {
    ...
    /*
     * Create a Edge It consists of src - source dest - destination weight - weight
     * of the edge
     */
    class Edge {
        int src, dest, weight;
    ...
    void bellmanFord(Graph graph, int src) {
        ...
        // Initailize the distance array and assign Integer.MAX_VALUE to all the
        // positions.
        ...
        /*
         * Iterate (vertices - 1) times over all the edges and do the relaxation on each
         * vertex.
         */
