public class Kth_Greatest_Element {

    private int[] heap;
    private int size;
    private int max_size;

    Kth_Greatest_Element(int max_size) {
    ...
    // Function to find the Kth greatest element
    public int KthGreatestElement(int k) {
        for (int i = 1; i < k; i++)
            extractMax();
        return extractMax();
    }
    ...
    public static void main(String[] args) {
        ...
        Kth_Greatest_Element maxHeap = new Kth_Greatest_Element(15);
        maxHeap.insert(5);
        maxHeap.insert(3);
        maxHeap.insert(17);
        maxHeap.insert(10);
        ...
        int k = 3;
        System.out.println(k + "rd greatest element is " + maxHeap.KthGreatestElement(k));
